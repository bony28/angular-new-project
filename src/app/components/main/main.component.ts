...
@Component({
  ...
  template: `
    ...
    <div
      style="padding: 2rem; background-color: #f5f5f5; border-radius: 12px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); max-width: 500px; margin: 2rem auto; font-family: Arial, sans-serif;"
    >
      <h2
        style="margin-bottom: 1rem; font-size: 1.5rem; color: #333; text-align: center;"
      >
        Pick a color to change the heading color
      </h2>
      <div
